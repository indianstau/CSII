...
UPDATE `csiisysdb2`.`syain_main` SET `FIRST_NAME_KANJI`='渡辺', `LAST_NAME_KANJI`='高介',`TAISYA_DATE`='2022-12-03',`NYUUSYA_DATE`='2016-07-01' WHERE  `SYAIN_ID`=2;
...
UPDATE `csiisysdb2`.`syain_main` SET `FIRST_NAME_KANJI`='堂本', `LAST_NAME_KANJI`='まくろ',`TAISYA_DATE`='2020-07-07',`NYUUSYA_DATE`='2019-05-01' WHERE  `SYAIN_ID`=6;
